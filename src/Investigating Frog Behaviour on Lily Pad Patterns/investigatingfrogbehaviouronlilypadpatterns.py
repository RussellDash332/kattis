...
from bisect import *; from itertools import *; from collections.abc import *; from operator import *; from functools import *; from math import *; from array import *
...
for _ in range(q): x = int(input())-1; p = bisect(b, v:=a[x]); a[x] = b.pop(p); b.add(v); print(a[x])